...
//  Legacy modeName1/modeName2 tables, indexed by DisplayMode (1..4).
static const char* const NAME1[5] = { "", "Peak Envelope", "Forward and",
                                      "dBm Meter", "Modulation" };
static const char* const NAME2[5] = { "", "Power Bargraph", "Reflected Power",
                                      "and SWR Bargraph", "Scope" };
